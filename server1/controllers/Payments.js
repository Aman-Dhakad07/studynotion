...
//         return res.status(200).json({
//           success:false,
//           mesage:"Student is already Enrolled in this course"
//         });
//       }
...
//       const rezorpay_order_id = req.body?.rezorpay_order_id;
//       const razorpay_payment_id = req.body?.razorpay_payment_id;
//       const razorpay_signature = req.body?.razorpay_signature;
//       const courses = req.body?.courses;
//       const userId = req.user.id;

//       if(!rezorpay_order_id || 
//         !razorpay_payment_id ||
//         !razorpay_signature ||
//         !courses  || !userId) {
...
//         }
//         let body  = rezorpay_order_id + "|" + razorpay_payment_id;
...
//               //return res
//               return res.status(200).json({success:false,message:"Payment Verified"});
//             }
...
//                   //fint the course and enroll the student in the course 
//                   const enrolledCourse   = await Course.findOneAndUpdate (
//                                                   {_id:courseId},
...
//                                                    "Congratulatio,you are onboarded into new codeHelp Course"
