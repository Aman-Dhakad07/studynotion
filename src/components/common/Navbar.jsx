                    ...
                    >
                      ...
                      <div className="invisible absolute left-[50%] top-[50%] z-[1000] flex w-[200px] translate-x-[-50%] translate-y-[3em] flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-[300px]">
                        ...
                        {loading ? (
                          ...
                          <>
                            {/* This code snippet is filtering the categories and not showing any courses on the display */}
                            {/* {subLinks
                              ?.filter(
...
// import ProfileDropDowm from "../core/Auth/ProfileDropDown"
// import { apiConnector } from '../../services/apiconnector'
// import { categories } from '../../services/apis'
...
//                         <div className='invisible absolute left-[50%] top-[-150%]  translate-x-[-50%]  translate-y-[80%]
...
//                                             <Link to={`${subLink.link}`} key={index} className='font-bold text-richblack-500'> 
//                                                  <p>{subLink.title}</p>
//                                             </Link>
//                                         ))
